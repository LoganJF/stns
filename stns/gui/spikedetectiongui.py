...
class SpikeDetectionGUI(tk.Tk):
    """An object used to create a gui for Spike Analysis (in the Cancer Borealis Stomatagastric Nervous System) using
    Spike2 files
    ...
    def __init__(self, provided_path = None, *args, **kwargs):
        ...
        self.container = tk.Frame(self, width=800, height=600)
    ...
    def add_frame(self, new_frame):
        """Adds a frame to the container stack
    ...
    def get_page(self, page_class):
        """Returns the requested page to the top of the stack
...
if __name__ == '__main__':
    ...
    #file_names = sorted(glob('/Users/loganfickling/Downloads/Hemo*/fed hemo incubation/*/fed hemo/*/*.smr'))#[0]
    file_names = sorted(glob('/Users/loganfickling/Downloads/Hemo*/2-7-23*/*.smr'))  # [0]
...
# TODO: Make it so that the add channel window auto-closes once user hits add channel
# TODO: Fix it so that it doesn't keep re-adding the last deleted channel each time it plots