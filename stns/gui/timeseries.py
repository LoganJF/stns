...
class TimeseriesPage(tk.Frame):
    ...
    def create_adjust_y_axis_window(self):
        ...
        page = self.controller.get_page("SelectChannelPage") # Makes sure you know for which channel
    ...
    def update_y_axis(self, n_ticks=10.):
        ...
        :param n_ticks: int, number of nicks to display
        :return: updated y-axis
        """
    ...
    def add_channel(self):
        ...
        Button(self.add_ch_window, text="Add Channel", command=self.append_channel).grid(row=2, column=0)
    ...
    def append_channel(self):
        ...
        page = self.controller.get_page("SelectChannelPage")
        page.set_channel_data(channel_name=channel)
        self.add_plot()
